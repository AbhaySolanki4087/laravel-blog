...
<body class="bg-light">
  ...
  <div class="container-fluid mt-3 d-flex ">
    <div class="col-lg-8 ms-5">
          ...
          <div class="card-body">
            <div class="d-flex justify-content-between align-items-center mb-2">
              ...
              <div class="d-flex align-items-center gap-2">
                  <p class="mb-0"><strong>Likes:</strong> <span class="like-count">{{ $blog->likes }}</span></p>
        ...
        @empty($blog)
       <div class="card shadow-sm mb-4">
          <img src="https://via.placeholder.com/800x400" class="card-img-top" alt="Blog Image" height="400">
          <div class="card-body">
              <div class="d-flex justify-content-between align-items-center mb-2">
                  <h3 class="card-title mb-0">Understanding HTML Basics</h3>
                  <div class="d-flex align-items-center gap-2">
                      <p class="mb-0"><strong>Likes:</strong> <span class="like-count">10</span></p>
                      <button class="btn btn-warning btn-sm like-btn" onclick="toggleLike(this)">❤️ Like</button>
                  </div>
              </div>
              <p class="card-text">
                  This is where full blog content will appear. You can show the blog’s details and allow admin to preview before editing.
              </p>
          </div>
        </div>
